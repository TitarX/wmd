<%-- 
    Document   : index
    Created on : Jun 16, 2011, 4:41:20 PM
    Author     : TitarX
--%>
...
<html>
    <head>
        ...
        <meta name="keywords" content="система учёта кредитов, онлайн, вебмани, веб-мани, учёт, расчёт, кредиты, кредитование, калькулятор компенсации за задержку возврата кредита" />
        <meta name="description" content="Система учёта кредитов" />
        ...
        <title>Система учёта кредитов<%= " " + wmid%></title>
    </head>
    <body>
        <div id="wrapper">
            <div id="top-lable">
