<%-- 
    Document   : notebook
    Created on : Jun 26, 2011, 11:09:49 PM
    Author     : TitarX
--%>
...
<html>
    <head>
        ...
        <title>Записная книжка<%= " " + wmid%></title>
    </head>
    <body>
        <div id="wrapper">
            <div id="top-lable">
            ...
            <div id="content">
                <center>
                    ...
                    <p><span class='warning'>Заголовок должен быть уникальным в записной книжке</span></p>
                    <%
                    ...
                    <table id="notes" width="100%">
                        <thead>
                            ...
                            <tr align="center">
                                <th class="titleNotes">Заголовки</th>
                            </tr>
                        </thead>
                        <tbody>
                            <%
                                ...
                                String sqlQuery = "SELECT \"Title\",\"ID\" FROM \"Notes\" WHERE \"WMID\"='" + wmid + "' ORDER BY \"Title\" ASC;";
                    ...
                    <div id="boxes">
                        <div id="dialog">
                            ...
                            <form action="/WMD/servlets/writeNote" method="post" name="addNoteForm" class="forNodeForm">
                                ...
                                <input type="hidden" id="tableName" name="tablename" value="Notes"/>
                                <table class="forNodeForm">
                                    <tr>
                                        <td colspan="2" align="center"><strong>Заголовок:</strong></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        <td colspan="2" align="center"><strong>Запись:</strong></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
