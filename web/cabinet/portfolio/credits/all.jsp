<%-- 
    Document   : all
    Created on : Jul 3, 2011, 5:51:22 PM
    Author     : TitarX
--%>
...
<%
    ...
    session.setAttribute("referer", "/cabinet/portfolio/credits/all.jsp");
%>
<%
...
<html>
    <head>
        ...
        <meta name="description" content="Все кредиты" />
        ...
        <div id="wrapper">
            ...
            <div id="content">
                ...
                <div>
                    ...
                    |<a href="/WMD/cabinet/portfolio/credits/all.jsp"><span class="thispage">Все</span></a>|
                </div>
                <p>
                    <span class='warning'>
                        <%
                ...
                %>
                <center>
                    <form name="periodForm" method="post" action="/WMD/cabinet/portfolio/credits/all.jsp"
                          onkeyup="copyFields();"
                        ...
                        <tbody>
                            <%
                                ...
                                String sqlQuery = "SELECT \"Borrower\",\"Ncredit\",\"Creditsumm\",\"Returnsumm\",\"Return\""
                                        ...
                                        + "FROM \"Credits\" WHERE \"WMID\"='" + wmid + "' " + betweenDate + "ORDER BY \"Begindate\" DESC;";
