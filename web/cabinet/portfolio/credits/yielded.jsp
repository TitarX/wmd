<%-- 
    Document   : ex
    Created on : Jul 3, 2011, 5:51:45 PM
    Author     : TitarX
--%>
...
<%
    ...
    session.setAttribute("referer", "/cabinet/portfolio/credits/yielded.jsp");
%>
<%
...
<html>
    <head>
        ...
        <meta name="keywords" content="выданные кредиты" />
        <meta name="description" content="Выданные кредиты" />
        ...
        <title>Выданные кредиты<%= " " + wmid%></title>
    </head>
    <body>
        <div id="wrapper">
            <div id="top-lable">
            ...
            <div id="content">
                ...
                <div>
                    ...
                    |<a href="/WMD/cabinet/portfolio/credits/yielded.jsp"><span class="thispage">Выданные</span></a>|
                ...
                %>
                <center>
                    <form name="periodForm" method="post" action="/WMD/cabinet/portfolio/credits/yielded.jsp"
                          onkeyup="copyFields();"
                        ...
                        <tbody>
                            <%
                                ...
                                String sqlQuery = "SELECT \"Borrower\",\"Ncredit\",\"Creditsumm\",\"Returnsumm\",\"Return\""
                                        ...
                                        + "FROM \"Credits\" WHERE \"WMID\"='" + wmid + "' AND \"Status\"='1' " + betweenDate + "ORDER BY \"Begindate\" DESC;";
