<%-- 
    Document   : delay
    Created on : Jul 3, 2011, 6:07:57 PM
    Author     : TitarX
--%>
...
<%
    ...
    session.setAttribute("referer", "/cabinet/portfolio/credits/delay.jsp");
%>
<%
...
<html>
    <head>
        ...
        <meta name="keywords" content="просроченные кредиты" />
        <meta name="description" content="Просроченные кредиты" />
        ...
        <title>Просроченные кредиты<%= " " + wmid%></title>
    </head>
    <body>
        <div id="wrapper">
            <div id="top-lable">
            ...
            <div id="content">
                ...
                <div>
                    ...
                    |<a href="/WMD/cabinet/portfolio/credits/delay.jsp"><span class="thispage">Просроченные</span></a>|
                ...
                %>
                <center>
                    <form name="periodForm" method="post" action="/WMD/cabinet/portfolio/credits/delay.jsp"
                          onkeyup="copyFields();"
                        ...
                        <tbody>
                            <%
                                ...
                                String sqlQuery = "SELECT \"Borrower\",\"Ncredit\",\"Creditsumm\",\"Returnsumm\",\"Return\""
                                        ...
                                        + "FROM \"Credits\" WHERE \"WMID\"='" + wmid + "' AND \"Status\"='3' " + betweenDate + "ORDER BY \"Begindate\" DESC;";
